...
import com.lucascabral.todocomposeapp.components.DisplayAlertDialog
...
fun ExistingTaskAppBarActions(
    ...
    DisplayAlertDialog(
        title = stringResource(id = R.string.dialog_delete_task, selectedTask.title),
        message = stringResource(id = R.string.dialog_delete_confirmation, selectedTask.title),
